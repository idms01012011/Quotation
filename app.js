const scriptURL = "https://script.google.com/macros/s/AKfycbztEdS5_c0u2o9doaSurD97CSrAdq_PWNTRsZEBbvVTF5OUMdm4TnL2IpH-VOflMSNv9g/exec";
...
const schemas = {
    service: ["id", "เลขที่ใบงาน", "ลำดับ", "วันที่เปิดงาน", "วันที่ปิดงาน", "ประเภทงาน", "ชื่อโรงพยาบาล", "ชื่อเครื่อง", "ยี่ห้อ", "รุ่น",
        ...
        "ลายเซ็นช่าง", "รูปภาพ1", "รูปภาพ2", "รูปภาพ3", "รูปภาพ4", "หมายเหตุ"
    ],
    ...
    equipment: ["id", "ลำดับ", "วันที่", "ชื่อเครื่อง", "ประเภท", "ยี่ห้อ", "รุ่น", "หมายเลขเครื่อง/รหัส", "สถานะ", "ราคา", "จำนวน", "รูปภาพอุปกรณ์"],
...
const displayColumns = {
    ...
    equipment: ["ชื่อเครื่อง", "ยี่ห้อ", "รุ่น", "สถานะ", "จำนวน", "รูปภาพอุปกรณ์"],
